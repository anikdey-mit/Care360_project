...
def safety_questionnaire():
    ...
    if form.validate_on_submit():
        ...
        session['stairs_condition'] = form.stairs_condition.data
        ...
        walk_difficulty = form.walk_difficulty.data
        grab_bars = form.grab_bars.data
        difficulty_chair = form.difficulty_chair.data
        stairs_condition = form.stairs_condition.data
        smoke_detector = form.smoke_detector.data
        fire_extinguisher = form.fire_extinguisher.data
        emergency_contact = form.emergency_contact.data

        #create new object to insert in the database
        new_entry = safety_questionnaire_database(kid_name, unsteady_standing, water_presence, kitchen_reach, slip_products, electrical_cords, stairs_handrails,
    ...
    #render the template for the current view
        ...
        return render_template('safetquestionnairepage.html', form=form)
